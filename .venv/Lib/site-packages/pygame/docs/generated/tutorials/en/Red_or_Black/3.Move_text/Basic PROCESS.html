...
<html lang="en" data-content_root="../../../../">
  <head>
    ...
    <link rel="next" title="Author: Youngwook Kim (Korean)" href="../4.Control_text/Basic%20INPUT.html" />
    <link rel="prev" title="Author: Youngwook Kim (Korean)" href="../2.Print_text/Basic%20TEMPLATE%20and%20OUTPUT.html" /> 
  </head><body>  
...
<section id="setting-for-animation">
<p>Previous project looks like a single image instead of game. Because there is no input neither process to control output. Of course, clicking exit button on window is not counted because it is just shutting down the entire program. First, we will let text “Hello World!” to move automatically (and now project will be looks like an animation rather than single image), which means adding first processing logic on this project. How to move text? We know that location of text is initialized in Initial statement. So, location of text should be updated in Always statement, with adding some variable to process something.</p>
<img alt="../../../../_images/Bagic-PROCESS-sourcecode.webp" class="inlined-right" src="../../../../_images/Bagic-PROCESS-sourcecode.webp" />
...
<span class="linenos"> 4</span><span class="n">size</span> <span class="o">=</span> <span class="n">width</span><span class="p">,</span> <span class="n">height</span> <span class="o">=</span> <span class="mi">220</span><span class="p">,</span> <span class="mi">140</span>
...
<span class="linenos">10</span><span class="n">ball</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">image</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;Bagic-PROCESS-sourcecode.webp&quot;</span><span class="p">)</span>
...
<img alt="../../../../_images/Bagic-PROCESS-resultscreen.webp" class="inlined-right" src="../../../../_images/Bagic-PROCESS-resultscreen.webp" />
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="linenos"> 1</span><span class="kn">import</span><span class="w"> </span><span class="nn">sys</span><span class="o">,</span><span class="w"> </span><span class="nn">pygame</span>
<span class="linenos"> 2</span><span class="n">pygame</span><span class="o">.</span><span class="n">init</span><span class="p">()</span>
<span class="linenos"> 3</span>
<span class="linenos"> 4</span><span class="n">size</span> <span class="o">=</span> <span class="n">width</span><span class="p">,</span> <span class="n">height</span> <span class="o">=</span> <span class="mi">220</span><span class="p">,</span> <span class="mi">140</span>
...
<span class="linenos"> 8</span><span class="n">screen</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">display</span><span class="o">.</span><span class="n">set_mode</span><span class="p">(</span><span class="n">size</span><span class="p">)</span>
<span class="linenos"> 9</span>
<span class="linenos">10</span><span class="n">ball</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">image</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;Bagic-PROCESS-resultscreen.webp&quot;</span><span class="p">)</span>
<span class="linenos">11</span><span class="n">ballrect</span> <span class="o">=</span> <span class="n">ball</span><span class="o">.</span><span class="n">get_rect</span><span class="p">()</span>
<span class="linenos">12</span>
<span class="linenos">13</span><span class="k">while</span> <span class="kc">True</span><span class="p">:</span>
<span class="linenos">14</span>    <span class="k">for</span> <span class="n">event</span> <span class="ow">in</span> <span class="n">pygame</span><span class="o">.</span><span class="n">event</span><span class="o">.</span><span class="n">get</span><span class="p">():</span>
...
<p>(Source Code for Moving World Project and its result screen)</p>
<p>(Not the entire source code of Moving World Project, but part)</p>
<p>(Moving World! moves automatically just like Arkanoid ball or DVD screensaver.)</p>
<p>New line #1 - #5 were appended at the end of Initial statement. Also, multiple if-else phases (#6 - #9) were inserted at the beginning of Always statement, with line #11 at the end of always statements. We can understand what commands of #2 - #10 do. They just change variables for position of “Moving World” when Always statement being started. But there is a problem. How fast is “Moving World?” It is sure that displacement of “Moving World” is sqrt(2) (simple Pythagorean equation). But how often displacement of “Moving World” is changed? It can’t be determined without calculating time complexity of Always statement! (Because it depends on how often Always statement being started) And time complex will be differ to computer to computer, so can’t be fixed.</p>
<p>We need to add the conception of <strong>fixed speed</strong> into this project. How? Look at #1 and #11. There is <code class="docutils literal notranslate"><span class="pre">pygame.time.Clock()</span></code> on Initial statement and <code class="docutils literal notranslate"><span class="pre">tick(60)</span></code> on Always statement. 60 means FPS (frame rate per second). We know that FPS means how often display is changed in 1 second. What function means change (= update) display in pygame? That’s right. Pygame.display.update() function. So, FPS means how often Always statement being executed in 1 second. Because there is 1 Pygame.display.update() function in 1 always statements. (So, FPS means <strong>selective delay</strong> according to current program’s process speed, <strong>not selective acceleration</strong>, so FPS cannot work if FPS is too high.) If we let fps(= <strong>time</strong>) to be fixed in this project, we can change <strong>velocity</strong> of certain game object by finding appropriate value for <strong>displacement</strong>. pygame.time.Clock() is needed to fix the speed of project before game started. Notice that tick function has to be called when Pygame.display.update() is called. Because tick counts the number of update function. It is one of the exception of function that can be executed after Pygame.display.update().</p>
<p>Okay, we learn that “Fixing time” is needed when screen is updated. Every screen of dynamic game is frequently changed unless it is static game. So, we have to know that. However, this project isn’t look like a game because its result can be anticipated easily (there is no input to change result) Now, input logic will be inserted.</p>
<p>&lt;Reference Code&gt;</p>
...
<span class="n">pygame</span><span class="o">.</span><span class="n">display</span><span class="o">.</span><span class="n">set_caption</span><span class="p">(</span><span class="s2">&quot;Moving World Project&quot;</span><span class="p">)</span>
...
<span class="n">myText</span> <span class="o">=</span> <span class="n">myTextFont</span><span class="o">.</span><span class="n">render</span><span class="p">(</span><span class="s2">&quot;Moving World!&quot;</span><span class="p">,</span> <span class="kc">True</span><span class="p">,</span> <span class="n">red</span><span class="p">,</span> <span class="n">green</span><span class="p">)</span>
...
<span class="n">fpsClock</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">time</span><span class="o">.</span><span class="n">Clock</span><span class="p">()</span> <span class="c1">#1</span>
<span class="n">x</span> <span class="o">=</span> <span class="mi">0</span> <span class="c1">#2</span>
<span class="n">y</span> <span class="o">=</span> <span class="mi">0</span> <span class="c1">#3</span>
<span class="n">moveRight</span> <span class="o">=</span> <span class="mi">1</span> <span class="c1">#4</span>
<span class="n">moveUp</span><span class="o">=</span> <span class="mi">1</span> <span class="c1">#5</span>
...
<span class="k">while</span> <span class="kc">True</span><span class="p">:</span>
    <span class="k">if</span> <span class="p">(</span><span class="n">moveRight</span> <span class="o">==</span> <span class="mi">1</span><span class="p">):</span> <span class="c1">#6</span>
        ...
        <span class="k">if</span> <span class="p">(</span><span class="n">x</span> <span class="o">&gt;=</span> <span class="mi">320</span> <span class="o">-</span> <span class="mi">75</span><span class="p">):</span>
            <span class="n">moveRight</span> <span class="o">=</span> <span class="mi">0</span>
    <span class="k">elif</span> <span class="p">(</span><span class="n">moveRight</span> <span class="o">==</span> <span class="mi">0</span><span class="p">):</span> <span class="c1">#7</span>
        <span class="n">x</span> <span class="o">=</span> <span class="n">x</span> <span class="o">-</span> <span class="mi">1</span>
        <span class="k">if</span> <span class="p">(</span><span class="n">x</span> <span class="o">&lt;=</span> <span class="o">-</span><span class="mi">320</span> <span class="o">+</span> <span class="mi">75</span><span class="p">):</span>
            <span class="n">moveRight</span> <span class="o">=</span> <span class="mi">1</span>

    <span class="k">if</span> <span class="p">(</span><span class="n">moveUp</span> <span class="o">==</span> <span class="mi">1</span><span class="p">):</span> <span class="c1">#8</span>
        <span class="n">y</span> <span class="o">=</span> <span class="n">y</span> <span class="o">+</span> <span class="mi">1</span>
        <span class="k">if</span> <span class="p">(</span><span class="n">y</span> <span class="o">&gt;=</span> <span class="mi">240</span> <span class="o">-</span> <span class="mi">15</span><span class="p">):</span>
            <span class="n">moveUp</span> <span class="o">=</span> <span class="mi">0</span>
    <span class="k">elif</span> <span class="p">(</span><span class="n">moveUp</span> <span class="o">==</span> <span class="mi">0</span><span class="p">):</span> <span class="c1">#9</span>
        <span class="n">y</span> <span class="o">=</span> <span class="n">y</span> <span class="o">-</span> <span class="mi">1</span>
        <span class="k">if</span> <span class="p">(</span><span class="n">y</span> <span class="o">&lt;=</span> <span class="o">-</span><span class="mi">240</span> <span class="o">+</span> <span class="mi">15</span><span class="p">):</span>
            <span class="n">moveUp</span> <span class="o">=</span> <span class="mi">1</span>



<span class="n">myTextArea</span><span class="o">.</span><span class="n">center</span> <span class="o">=</span> <span class="p">(</span><span class="mi">320</span> <span class="o">+</span> <span class="n">x</span><span class="p">,</span> <span class="mi">240</span> <span class="o">+</span> <span class="n">y</span><span class="p">)</span> <span class="c1">#10</span>
...
<span class="n">fpsClock</span><span class="o">.</span><span class="n">tick</span><span class="p">(</span><span class="mi">60</span><span class="p">)</span> <span class="c1">#11</span>
</pre></div>
</div>
</section>
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/tutorials\en\Red_or_Black\3.Move_text\Basic PROCESS.rst" rel="nofollow">Edit on GitHub</a>
