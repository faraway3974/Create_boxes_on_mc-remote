...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.event &#8212; pygame-ce v2.5.7 documentation</title>
...
<span class="n">MOUSEBUTTONUP</span>     <span class="n">pos</span><span class="p">,</span> <span class="n">button</span><span class="p">,</span> <span class="n">touch</span><span class="p">,</span> <span class="n">clicks</span>
<span class="n">MOUSEBUTTONDOWN</span>   <span class="n">pos</span><span class="p">,</span> <span class="n">button</span><span class="p">,</span> <span class="n">touch</span><span class="p">,</span> <span class="n">clicks</span>
...
<div class="versionchangedold">
<p><span class="versionmodified changed">Changed in pygame 2.5.7: </span>The <code class="docutils literal notranslate"><span class="pre">clicks</span></code> attribute was added to <code class="docutils literal notranslate"><span class="pre">MOUSEBUTTONDOWN</span></code> and <code class="docutils literal notranslate"><span class="pre">MOUSEBUTTONUP</span></code> events.</p>
</div>
<p>The <code class="docutils literal notranslate"><span class="pre">clicks</span></code> attribute of the <code class="docutils literal notranslate"><span class="pre">MOUSEBUTTONDOWN</span></code> and <code class="docutils literal notranslate"><span class="pre">MOUSEBUTTONUP</span></code> events indicate the number of clicks occurring
in rapid succession, e.g. <code class="docutils literal notranslate"><span class="pre">1</span></code> for single-click, <code class="docutils literal notranslate"><span class="pre">2</span></code> for double-click, etc. Note that double, triple, or more clicks
will still fire mouse events for each individual click, with a progressively increasing <code class="docutils literal notranslate"><span class="pre">clicks</span></code> attribute.</p>
