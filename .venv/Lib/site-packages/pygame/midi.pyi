...
def midis2events(
    midis: Iterable[SequenceLike[SequenceLike[int] | int]], device_id: int
) -> list[Event]: ...
def time() -> int: ...
...
class Input:
    ...
    def close(self) -> None: ...
    def poll(self) -> bool: ...
    def read(self, num_events: int) -> list[list[list[int] | int]]: ...
...
class Output:
    ...
    def write(self, data: Iterable[SequenceLike[SequenceLike[int] | int]]) -> None: ...
    def write_short(self, status: int, data1: int = 0, data2: int = 0) -> None: ...
    def write_sys_ex(self, when: int, msg: list[int] | str) -> None: ...
