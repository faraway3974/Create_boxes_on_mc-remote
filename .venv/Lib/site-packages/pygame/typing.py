...
_PathLike: TypeAlias = str | bytes | _PathProtocol[str] | _PathProtocol[bytes]
# Most pygame functions that take a file argument should be able to handle a FileLike type
FileLike: TypeAlias = _PathLike | IO[bytes] | IO[str]
